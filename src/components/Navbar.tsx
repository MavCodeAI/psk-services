        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          {externalLinks.map((link) => (
            <button
              ...
              className={cn(
                'text-white hover:text-psyco-green-DEFAULT transition-all duration-300 text-sm font-medium tracking-wide cursor-pointer scale-hover relative',
                location.pathname === link.path && 'text-psyco-green-DEFAULT'
              )}
            >
              {link.name}
